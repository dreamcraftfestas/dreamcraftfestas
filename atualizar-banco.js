...
const PASTA_IMAGENS = path.join(__dirname, 'Imagem');
const ARQUIVO_SCRIPT = path.join(__dirname, 'scriptdecor.js'); // ou o caminho correto até o seu JS
...
function atualizarBanco() {
  ...
  // 1. Lê o conteúdo atual do seu scriptdecor.js
  ...
  if (!regexBanco.test(conteudoScript)) {
    console.error('❌ Erro: Não foi possível localizar "const bancoDadosTemas = [...];" no seu scriptdecor.js');
    return;
  }
  ...
  // 5. Junta tudo de volta e sobrescreve o arquivo scriptdecor.js
  ...
  console.log('✅ Sucesso! O arquivo scriptdecor.js foi atualizado com a quantidade exata de imagens de cada pasta.');
}
