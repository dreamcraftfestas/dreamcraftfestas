...
const bancoDadosTemas = [
    ...
    { nome: "1ª Volta ao Sol", pasta: "1voltaaosol", categorias: "all 1ano" },    
    ...
    { nome: "101 Dalmatas", pasta: "101dalmatas", categorias: "all filme desenho" },
    { nome: "Ano Novo Branco", pasta: "anonovobranco", categorias: "all anonovo" },
    { nome: "Ano Novo Dourado", pasta: "anonovodourado", categorias: "all anonovo" },
    { nome: "Ano Novo Prata", pasta: "anonovoprata", categorias: "all anonovo" },
    ...
    { nome: "Anos 90 Prata", pasta: "anos90prata", categorias: "all anos90" },
    { nome: "Arca de Noé", pasta: "arcadenoe", categorias: "all religiosos" },
    { nome: "Arco Iris Boho", pasta: "arcoirisboho", categorias: "all arcoiris" },
    ...
    { nome: "Hallowen", pasta: "hallowen", categorias: "all diadasbruxas" },
    { nome: "Happy Birthday Roxo Lantejoula", pasta: "happybirthdayroxolantejoula", categorias: "all happybirthday" },
    { nome: "Happy Birthday Dourado", pasta: "happybirthdaydourado", categorias: "all happybirthday" },
    { nome: "Homem Aranha Cute", pasta: "homemaranhacute", categorias: "all herois filme desenhos cute" },
    { nome: "Homem Aranha Miles Morales", pasta: "homemaranhamilesmorales", categorias: "all herois filme desenhos" },
    ...
    { nome: "Meus 20 anos depois dos 20", pasta: "meus20anosdepoisdos20", categorias: "all 1ano" },
    ...
    { nome: "Natal Verde", pasta: "natalverde", categorias: "all natal" },
    { nome: "Natal Vermelho", pasta: "natalvermelho", categorias: "all natal" },
    ...
    { nome: "Painel Pallet", pasta: "painelpallet", categorias: "all diversos 20anos" },
